...
if ($is_member_login) :
    ...
    <div class="d-flex">
        <div style="width: 16rem;" class="bg-grey-light p-4" id="member_sidebar">
            ...
            <a href="index.php?p=member&sec=membercard" class="btn btn-primary btn-block" target="_blank"><i class="fas fa-address-card mr-2"></i><?php echo __('View Laboratory Card'); ?></a>
        ...
        <div class="flex-grow-1 p-4" id="member_content">
            ...
            <h1 class="mb-2">Hi, <?php echo $_SESSION['m_name']; ?> <a href="index.php?p=member&sec=membercard" title="View Laboratory Card" class="btn btn-primary" target="_blank"><i class="fas fa-address-card"></i></a></h1>
...
<?php else: ?>
    <div>
        <div class="tagline"><?php echo __('Laboratory Member Login'); ?></div>
        <div class="loginInfo">
            <?php 
            if (flash()->isEmpty())
            {
                echo __('Please insert your member ID and password given by laboratory system administrator. If you are laboratory\'s member and don\'t have a password yet, please contact laboratory staff.'); 
            }
        ...
        <div class="loginInfo">
            <form action="index.php?p=member&destination=<?= urlencode(simbio_security::xssFree($_GET['destination'] ?? '')) ?>" method="post">
                ...
                <input type="submit" name="logMeIn" value="<?php echo __('Login'); ?>" class="memberButton"/>
					<a target="_blank" title="Support Us" class="memberButton"
						href="index.php?p=daftar_keanggotaan_mandiri"><i
								class=\\"fas fa-heart mr-2"></i><?= __('Daftar Mandiri'); ?></a>
            </form>
        </div>
    </div>
<?php endif; ?>
