...
<head>
    ...
    <style>
        .s-user:after,
        #sidepan {
            background-color: <?= $sysconf['admin_template']['default_color']??'#ff0000ff'; ?> !important;
        }
...
<nav id="sidepan">
    <div class="s-user" id="profile">
        ...
        <?php echo isset($_SESSION['nname']) ? $_SESSION['nname'] : __('Laboran'); ?>
        </a>
    </div>
...
<footer>
  <div class="row py-4">
    <div class="flex font-thin text-sm">
        <div class="flex-1">&copy; <?php echo date('Y'); ?> &mdash; UPT. Laboratorium Terpadu Untag Banyuwangi</div>
    </div>
  </div>
</footer>
