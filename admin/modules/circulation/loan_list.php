...
if (isset($_SESSION['memberID'])) {
    ...
    // table header
    $headers = array(__('Return'), __('Extend'), __('Kode Eksemplar (Unit)'), __('Nama (Judul)'), __('Col. Type'), __('Loan Date'), __('Due Date'));
    ...
    if ($is_overdue) {
        echo '  <div class="alert alert-danger p-2 rounded-0">
                    <div class="row">
                        <div class="pt-2 col"><strong>'.__('Total amount of fine is').' '.currency($_total_temp_fines).'</strong></div>
