...
$menu['bibliography.header-bibliography'] = array('Header', __('KATALOG'));
$menu['bibliography.bibliography-list'] = array(__('Daftar Katalog'), MWB.'bibliography/index.php', __('Show Existing Bibliographic Data'));
$menu['bibliography.bibliography-add'] = array(__('Tambah Baru Katalog'), MWB.'bibliography/index.php?action=detail', __('Add New Bibliographic Data/Catalog'));
$menu['bibliography.header-items'] = array('Header', __('EKSEMPLAR (UNITS)'));
$menu['bibliography.item-list'] = array(__('Daftar Eksemplar (Unit)'), MWB.'bibliography/item.php', __('Show List of Library Items'));
$menu['bibliography.checkout-items'] = array(__('Daftar Eksemplar (Unit) Keluar'), MWB.'bibliography/checkout_item.php', __('Show List of Checkout Items'));
...
$menu['bibliography.biblio-data-export'] = array(__('Object Data Export'), MWB.'bibliography/export.php', __('Export Bibliographic Data To CSV format'));
$menu['bibliography.biblio-data-import'] = array(__('Object Data Import'), MWB.'bibliography/import.php', __('Import Data to Bibliographic Database from CSV file'));
$menu['bibliography.biblio-item-export'] = array(__('Object Item Export'), MWB.'bibliography/item_export.php', __('Export Item/Copies data To CSV format'));
$menu['bibliography.biblio-item-import'] = array(__('Object Item Import'), MWB.'bibliography/item_import.php', __('Import Data to Item/Copies database from CSV file'));
