...
$sysconf['template']['option'][$sysconf['template']['theme']] = [
    ...
    'map-desc' => [
        ...
        'type' => 'ckeditor',
        'default' => 'Jalan Adi Sucipto No. 26, Kelurahan Tamanbaru, Kecamatan dan Kabupaten Banyuwangi.<br>Telp. 0853-7700-4675<br>E-mail. labterpadu@untag-banyuwangi.ac.id<br>',
    ],
    'fb-link' => [
