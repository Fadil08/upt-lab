        ...
        <div class="row py-4">
            <div class="col-md-3">
              ...
              <?php } ?>
                ...
                <ul class="list-reset">
                    <li><a class="text-light" href="index.php?p=labinfo"><?= __('Information'); ?></a></li>
                    <li><a class="text-light" href="index.php?p=librarian"><?= __('Laboran'); ?></a></li>
                    <li><a class="text-light" href="index.php?p=login"><?= __('Admin'); ?></a></li>
                    <li><a class="text-light" href="index.php?p=visitor"><?= __('Visitor'); ?></a></li>
                </ul>
            </div>
            ...
            <div class="col-md-4 pt-8 md:pt-0">
                ...
                <div class="mb-2"><?= __('masukkan satu atau lebih kata kunci dari nama (judul), lokasi, atau subjek'); ?></div>
                ...
                <a target="_blank" title="Support Us" class="btn btn-outline-success mb-2"
                   href="https://untag-banyuwangi.ac.id"><i
                            class="fas fa-heart mr-2"></i><?= __('Untag Banyuwangi'); ?></a>
                <a target="_blank" title="Contribute" class="btn btn-outline-light mb-2"
                   href="https://sites.google.com/untag-banyuwangi.ac.id/lab-untag"><i
                            class=\\"fab fa-github mr-2"></i><?= __('Laboratory Information'); ?></a>
            </div>
        </div>
        <hr>
        <div class="flex font-thin text-sm">
			<p class="flex-1">&copy; <?php echo date('Y'); ?> &mdash; UPT. Laboratorium Terpadu</p>
            <div class="flex-1 text-right text-grey"><?= __('Powered by '); ?><code>s4i</code></div>
        </div>
    </div>
</footer>
