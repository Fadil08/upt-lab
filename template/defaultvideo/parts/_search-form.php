                ...
                <transition name="slide-fade">
                    <div v-if="show" class="advanced-wraper shadow mt-4" id="advanced-wraper"
						...
						<?php endif; ?>	   
                            ...
                            <a v-bind:class="{'btn-primary text-white': searchBy === 'location', 'btn-outline-secondary': searchBy !== 'location' }"
                               @click="searchOnClick('location')" class="btn mr-2 mb-2"><?= __('Location');?></a>
